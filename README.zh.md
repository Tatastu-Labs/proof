...
| 套餐 | 价格 | 印记数 | 状态 |
|------|------|--------|------|
| 首次印记 | $0 | 每个持久账号终身 1 次 | 已上线 |
| Tatastu 会员 | $20/月（含整个 [Tatastu 应用](https://tatastu.dev)） | 每月含 100 次 | 已上线 |
| 预付包 | $1 / $1.50 / $5 / $8 | 5 / 10 / 50 / 100 次（永不过期） | 已上线 |
| 批量包 | $35 / $65 / $120 | 500 / 1,000 / 2,000 次（永不过期） | 已上线 |
| 按次付费（x402） | $0.10 或 $0.05（API key） | 1 次 | 已上线 |

**验证永久免费，无需注册账号。**

购买页面只显示实时价格清单中可用的套餐。完整价格：[proof.tatastu.dev/pricing](https://proof.tatastu.dev/pricing)。
